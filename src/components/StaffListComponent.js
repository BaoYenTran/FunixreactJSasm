...
import { Card, CardTitle, CardImg, Row, Label, Col , Modal, ModalBody, ModalHeader, ModalFooter, FormFeedback, Button} from 'reactstrap';
        ...
        const staffList = staffListSearch.map((staff) => {
            return (
                ...
                <div className="col-6 col-md-4 col-lg-2 mt-3 mb-3" key={staff.id}>
                    <RenderStaffItem staff={staff} onDeleteStaff={this.props.deleteStaff} />
                </div>
            );
        });
